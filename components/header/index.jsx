        ...
        <div className="lg:px-[150px] px-10 py-10 flex lg:flex-row flex-col-reverse justify-start gap-10">
            ...
            <div className="block">
                ...
                <div className="flex gap-5 items-center mt-5">
                    <Link href="/product">
                        <button className="px-5 py-2 bg-red-500 text-white font-semibold shadow-lg shadow-red-300 hover:shadow-sm transition-all duration-300 ease">Shop Now</button>
                    </Link>
                    <Link href="/blog">
